...
public class TestUtils {
  ...
  public ReservationService setUpReservationService() {
    ...
    Movie spiderMan =
        new Movie("Spider-Man: No Way Home", "", Duration.ofMinutes(90), testTicketFullPrice, true);
    Movie turningRed =
        new Movie("Turning Red", "", Duration.ofMinutes(85), testTicketFullPrice, false);
    Movie theCheapTicketMovie =
        new Movie(
            "The Batman with George Clooney",
            "Uma Thurman is in it.",
            Duration.ofMinutes(95),
            cheapTicketFullPrice,
            true);
    Movie seventhOfMonthMovie =
        new Movie("The Batman", "", Duration.ofMinutes(95), testTicketFullPrice, false);
    Movie seventhOfMonthAndSpecialMovie =
        new Movie(
            "The Batman",
            "The one directed by Chris Nolan",
            Duration.ofMinutes(95),
            testTicketFullPrice,
            true);
    Movie matineeAndSpecialMovieOnSeventh =
        new Movie("The Batman", "", Duration.ofMinutes(95), testTicketFullPrice, true);
    Movie twelfthMovieNotSpecialNotMatineeWindowSixthDayOfMonth =
        new Movie(
            "The Crows Have Eyes",
            "The Crowening!",
            ...
            testTicketFullPrice,
            false);
    Movie eighthMovieNotSpecialNotMatineeWindowEighthDayOfMonth =
        new Movie(
            "The Crows Have Eyes",
            "The Crowening!",
            Duration.ofMinutes(9),
    ...
    List<Showing> schedule =
        List.of(
            ...
            new Showing(
                eighthMovieNotSpecialNotMatineeWindowEighthDayOfMonth,
                8,
                LocalDateTime.of(eighthOfMonth, LocalTime.of(21, 10))),
            new Showing(
                seventhOfMonthMovie, 9, LocalDateTime.of(seventhOfMonth, LocalTime.of(23, 0))),
            new Showing(
                seventhOfMonthAndSpecialMovie,
                10,
                LocalDateTime.of(seventhOfMonth, LocalTime.of(23, 0))),
            new Showing(
                matineeAndSpecialMovieOnSeventh,
                11,
                LocalDateTime.of(seventhOfMonth, nearEndMatineeWindow)),
            new Showing(
                twelfthMovieNotSpecialNotMatineeWindowSixthDayOfMonth,
                12,
                LocalDateTime.of(sixthOfMonth, endMatineeWindow)));
  ...
  public Theater setUpTheater() {
    ...
    Movie testMovie =
        new Movie(
            "Mean Girls",
            "A girl goes to public high school.",
