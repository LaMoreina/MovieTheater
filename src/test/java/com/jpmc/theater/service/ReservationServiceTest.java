...
class ReservationServiceTest {
    ...
    public void createReservationByShowNumber_specialMovieNoOtherEligibleDiscountSingleTicket_reservationCreatedAndSpecialDiscountApplied() {
        ...
        Reservation reservation = reservationService.createReservationByShowNumber(customerName, specialMovieNoOtherDiscountShowNumber, howManyTickets);
    ...
    public void createReservationByShowNumber_firstMovieNoOtherEligibleDiscountTwoTickets_reservationCreatedAndThreeDollarDiscountApplied() {
        ...
        Reservation reservation = reservationService.createReservationByShowNumber(customerName, firstShowNumber, howManyTickets);
    ...
    public void createReservationByShowNumber_secondMovieBeforeMatineeWindowTenTickets_reservationCreatedAndTwoDollarDiscountApplied() {
        ...
        Reservation reservation = reservationService.createReservationByShowNumber(customerName, secondShowNumber, howManyTickets);
    ...
    public void createReservationByShowNumber_seventhOfMonthOneTicket_DateDiscountApplied() {
        ...
        Reservation reservation = reservationService.createReservationByShowNumber(customerName, showNumberForSeventhOfMonthMovie, howManyTickets);
    ...
    public void createReservationByShowNumber_matineeAndSpecialMovieOnSeventh_matineeDiscountApplied() {
        ...
        Reservation reservation = reservationService.createReservationByShowNumber(customerName, matineeAndSpecialMovieOnSeventhShowNumber, howManyTickets);
    ...
    public void createReservationByShowNumber_twelfthMovieNotSpecialNotMatineeWindowSixthDayOfMonth_NoDiscountApplied() {
        ...
        Reservation reservation = reservationService.createReservationByShowNumber(customerName, noDiscountShowNumberOnSixth, howManyTickets);

        assertDiscountAndReservationDetails(howManyTickets, reservation, testTicketFullPrice);
    }
    @Test
    public void createReservationByShowNumber_MovieNotSpecialNotMatineeWindowEighthDayOfMonth_NoDiscountApplied() {
        int noDiscountShowNumberOnEighth = 8;
        int howManyTickets = 22;

        Reservation reservation = reservationService.createReservationByShowNumber(customerName, noDiscountShowNumberOnEighth, howManyTickets);

        assertDiscountAndReservationDetails(howManyTickets, reservation, testTicketFullPrice);
    }
    @Test
    public void createReservationByShowNumber_cheapTicketMatineeWithSeventhOfMonthDiscount_negativeDiscountTicketIsFree() {
        int cheapTicketOnSeventhShowNumber = 6;
        int howManyTickets = 1;

        Reservation reservation = reservationService.createReservationByShowNumber(customerName, cheapTicketOnSeventhShowNumber, howManyTickets);
    ...
    public void createReservationByShowNumber_ShowingHasNullFields_ExceptionCaught() {
        Movie movie = new Movie("Turning Red","", Duration.ofMinutes(85),
                testTicketFullPrice, false);
        List<Showing> schedule = List.of(
                new Showing(movie, 0, null));
